...
int http_remotehost (char *host, void *closure, SVZ_UNUSED void *ignored);
int http_localhost (char *host, void *closure, SVZ_UNUSED void *ignored);
int http_identification (char *ident, void *closure, SVZ_UNUSED void *ignored);
