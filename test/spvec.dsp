...
# ADD LINK32 kernel32.lib libserveez.lib /nologo /subsystem:console /pdb:none /machine:I386 /out:"spvec-test.exe" /libpath:"../src/libserveez/Opt"
...
# ADD LINK32 kernel32.lib libserveez.lib /nologo /subsystem:console /pdb:none /debug /machine:I386 /out:"spvec-test.exe" /libpath:"../src/libserveez/Dbg"
