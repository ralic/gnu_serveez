...
# ADD CPP /nologo /MT /W3 /GX /O2 /Ob2 /I "." /I ".." /I "../sizzle" /I "./src" /I "../.." /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "_WIN32" /D "__MINGW32__" /D "HAVE_CONFIG_H" /D __STDC__=0 /D "__USEDLL__" /FD /c
# SUBTRACT CPP /YX
...
# ADD LINK32 kernel32.lib wsock32.lib advapi32.lib sizzle.lib /nologo /subsystem:console /machine:I386 /libpath:"../sizzle/libsizzle/Opt"
...
# ADD LINK32 kernel32.lib wsock32.lib advapi32.lib sizzle.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"../sizzle/libsizzle/Dbg"
